  ...
  <>
    <div className="welcome">
      ...
      <p className="text">
        ...
        but because those who do not know to pursue pleasure consequences that are painful.
        Nor again is there anyone who loves or pursues or desires to obtain but because occasionally
        circumstances occur in which toil and pain can procure him some great pleasure.
        To take a trivial example, which of us ever undertakes laborious physical exercise,
        except to obtain some advantage from it? But who has right to find fault with a man
      </p>
      <p className="text">
        ...
        In a free hour, when our power of choice is untrammelled being able to do what we like best,
